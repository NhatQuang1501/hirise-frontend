...
import { Briefcase, Building, Calendar, Globe, MapPin } from "lucide-react";
        ...
        <div className="space-y-3 text-gray-700">
          {company.name && (
            <div className="flex items-start gap-2">
              <Building className="mt-1 size-4 text-gray-500" />
          ...
          {company.website && (
            <div className="flex items-start gap-2">
              <Globe className="mt-1 size-4 text-gray-500" />
              <a
          ...
          {company.industry_names && company.industry_names.length > 0 && (
            <div className="flex items-start gap-2">
              <Briefcase className="mt-1 size-4 text-gray-500" />
